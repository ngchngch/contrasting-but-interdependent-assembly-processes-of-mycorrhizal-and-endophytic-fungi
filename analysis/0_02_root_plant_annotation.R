...
snam_l <- read.csv("/Volumes/Transcend/data/Sugadaira_sequence/Final_merge/analysis/230415_make_mege_seqtab/sample_list.csv",
...
#==plant===#
##ITS_3pl62F1 
df_p <- readRDS("bioinfo_output/00_OTUtable_convert/0.97/seqOTUtab_plant_th0.97.rds")

#Plant annotation result with Manual BLAST search
taxa_p3 <- read.csv("metadata/Plant_annotaion_Genus.csv",row.names=1,header=T)
