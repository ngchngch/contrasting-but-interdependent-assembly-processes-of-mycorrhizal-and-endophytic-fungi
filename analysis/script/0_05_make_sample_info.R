...
taxa_f <- readRDS("data_process/06_Taxonomy_annotaion/fungi_annnotaion_results_dada2.rds")


site <- read.csv("Raw_data/metadata/sample_point_info.csv",row.names=3,header=FALSE)
