...
save.dir <- sprintf("%s/03_jsdm_model_comp_functinal_group_OTU93",current_dir)
...
seq <- read.fasta("data_process/05_Merge_sequence_output/Fungi/0.93/OTUseq_0.93.fasta")
...
cowplot::plot_grid(gpl+
          ...
          gcov+
            theme(axis.title.x=element_blank(),
                  plot.title = element_text(size=20)),
          align = "hv",nrow=1,
          labels=c("e","f","g","h"),label_size = 25)
