...
inputdir=${expid}/01_Demultiplexed_fastaq

target=Plant ## Fungi or Plant

outputdir= ${expid}/${target}/02_Cutadaptor_fastaq
fseq=NNNNNNACBTRGTGTGAATTGCAGRATC
rseq=NNNNNNTCCTCCGCTTATTKATATGC
thread=32
cutadaptpath=`which cutadapt`
## +++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++ ##
